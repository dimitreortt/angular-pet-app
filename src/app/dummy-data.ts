...
export const DummyData: PetInterface[] = [
  {
    id: 1,
    breed: 'Shiba Inu',
    url: 'https://material.angular.io/assets/img/examples/shiba2.jpg',
    description:
      'The Shiba Inu is the smallest of the six original and distinct spitz breeds of dog from Japan. Shiba Inu was originally bred for hunting.',
    favorite: true,
  },
  {
    id: 2,
    ...
    description:
      'These trusted companions often work as police dogs and service dogs because they are fiercely loyal to their main caretakers.',
    favorite: false,
  },
  {
    id: 3,
